---
name: onboarding
description: Use this skill after connecting and profiling a warehouse to collect the business context that agents need. Triggered during Phase 2 — ask about industry, data domain, key consumers, important metrics, and data gotchas. Use AskUserQuestion with pre-populated options from profiler data.
---

# Skill: Onboarding — Industry & Data Context

This skill governs the conversational questions that give agents the business context they need to build a good semantic layer. Ask one topic at a time. Keep it conversational, not a form.
...
After onboarding, add a context block to the agent prompt:
