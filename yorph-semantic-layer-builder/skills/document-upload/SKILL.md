...
description: Use this skill when the user uploads a file, pastes a URL, or mentions having a data dictionary, business glossary, SaaS context doc, or existing semantic layer. Also triggered after profiling when column names are cryptic (e.g. f_amt, cd_typ) and documentation would help.
---

# Skill: Document Upload & URL Context

This skill governs how the orchestrator handles user-provided documentation. Documents and URLs dramatically improve the quality of the semantic layer by giving agents documented business meaning — not just what the data looks like, but what it means.
