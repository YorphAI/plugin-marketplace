...
```
This is a saas data warehouse. The primary business process is Full SaaS stack: accounts, subscriptions, billing, usage, features, MRR history, and support tickets. Key challenge: BOTH subscriptions.mrr_amount AND mrr_history.mrr define MRR — the agent must identify which is the authoritative source..

Fact tables: accounts. Dimension tables: customers, products.
