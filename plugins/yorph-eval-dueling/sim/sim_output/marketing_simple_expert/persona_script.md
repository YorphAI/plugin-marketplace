...
```
This is a marketing data warehouse. The primary business process is A clean marketing schema: campaigns, clicks, and conversions. Tests whether the agent identifies ROAS, CPA, CTR, and conversion rate as the core marketing measures..
