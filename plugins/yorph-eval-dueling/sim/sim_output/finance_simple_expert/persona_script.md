...
```
This is a finance data warehouse. The primary business process is A minimal accounting schema: chart of accounts, journal entries, cost centers, and periods. Tests whether the agent identifies P&L structure, debit/credit accounting logic, and period-based measures..
