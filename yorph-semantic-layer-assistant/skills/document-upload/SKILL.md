...
description: Use this skill when the user wants to upload or provide supporting documents such as data dictionaries, SaaS app context docs, business context documents, or existing semantic layer definitions. Triggers include: "upload a document", "add a data dictionary", "I have a schema doc", "here's our existing semantic layer", "upload context", "paste a URL", "I have a Confluence doc".
---
