...
description: Use this skill when the user needs to choose the output format for their semantic layer. Triggers include: "choose output format", "what format", "I want dbt", "I want Snowflake YAML", "give me JSON", "OSI spec", "generate all formats", "what formats are available".
---
