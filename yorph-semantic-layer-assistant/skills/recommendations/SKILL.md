...
description: Use this skill to present the three semantic layer design recommendations and handle output generation once all agents have completed analysis. Triggers include: "show me the recommendations", "what did you find", "present results", "generate the output", "save the output", "which recommendation", "create the dbt file", "I choose option 2".
---

# Skill: Recommendations & Output

This skill governs Step 5 and Step 6 of the workflow — presenting the three semantic layer designs to the user, helping them choose or combine, then generating and saving the final output.

---

## When all 9 agents are done
